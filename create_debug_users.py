...
users = [
    #[username, id, full_name, first_name, last_name, email, is_teacher, is_student, is_superuser]
    ["2020jbeutner", 33538, "John Beutner", "John", "Beutner", "2020jbeutner@tjhsst.edu", False, True, False],
    ["2020fouzhins", 33797, "Theo Ouzhinski", "Theo", "Ouzhinski", "2020fouzhins@tjhsst.edu", False, True, False],
    ["pcgabor", None, "Peter Gabor", "Peter", "Gabor", "pcgabor@fcps.edu", True, False, False],
    ["admin", None, "Admin", "Admin", "Admin", "admin@example.com", False, False, True],
]
