$(function() {
  ...
  var list_grade_element = $("#submission-list-grade");
  ...
  if(output_div.hasClass("not-graded")) {
    ...
    function update() {
      ...
      if(update_in_count <= 0) {
        ...
        $.getJSON(latest_submission_json_url, {}, function(data) {
          if(data.error) {
            ...
            if(data.has_been_graded) {
              ...
              list_grade_element.text(data.points_received + "/" + data.points_possible + " (" + data.grade_percent + ")");
            }
